    ...
    <SafeAreaView className="flex-1 bg-gray-50">
      <View className=" flex-1 mb-2">
        <View className="flex-row justify-center relative h-11 border-b border-gray-300">
          ...
          >
            <ChevronLeftIcon color="#f2a900" size={26} />
          </TouchableOpacity>
          <Text className="text-xl">Giỏ hàng</Text>
        </View>
        <ScrollView className="flex-1">
          <View className="justify-between flex-row border-b py-2 border-gray-300">
            <Text className=" px-2 text-xl font-bold ">Đơn hàng</Text>
            <TouchableOpacity onPress={() => navigation.navigate("Menu")}>
              <Text className=" px-2 text-lg text-yellow-700 font-normal">
                + Thêm món
              </Text>
            </TouchableOpacity>
          </View>
          ...
          {CartProduct.listProduct.map((item, index) => {
            return (
              ...
              >
                <Text className="text-lg font-bold text-yellow-500">x1</Text>
                ...
                <View className="ml-4 flex-1 pr-3 relative">
                  ...
                  >
                    <Text className="font-bold text-sm text-yellow-500 px-2">Xóa</Text>
                  </TouchableOpacity>
      ...
      <View className="w-full h-44 bg-white">
        <View className="h-20 px-2">
          <View className="flex-row items-center justify-between">
            <Text className="text-base font-bold text-black-700">Tổng tiền:</Text>
            <Text className="text-base font-bold text-black-700">
              {CartProduct.price} đ
            </Text>
          </View>
         
          <View className="flex-row items-center justify-between">
            <Text className="text-base font-normal">Giảm giá khuyến mãi</Text>
            <Text className="text-base font-normal">0 đ</Text>
          </View>

          <View className="flex-row items-center justify-between">
            <Text className="text-base font-normal">Khuyến mãi thành viên</Text>
            <Text className="text-base font-normal">0 đ</Text>
          </View>
        </View>
        <View className="h-24 border border-gray-300 rounded-2xl">
          <View className="items-center">
            <View className="flex-row justify-between w-11/12 items-center pb-2 pt-1">
              <Text className="font-normal text-red-700 text-base">Giá bao gồm thuế VAT</Text>
          ...
          <View className="items-center">
            <TouchableOpacity
              ...
              className="w-11/12 h-12 bg-red-500 justify-center items-center rounded-md"
            >
