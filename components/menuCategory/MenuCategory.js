        ...
        >
            <TouchableOpacity onPress={() => {handlePress(1);setType('pizza')}} className="-mt-1 w-24  mx-3 rounded-lg">
                <Text
                    className={
                        active === 1
                            ? 'bg-yellow-500 rounded-lg text-white px-3 py-2 text-base text-center font-semibold'
            ...
            <TouchableOpacity onPress={() => {handlePress(2);setType('drink')}} className="-mt-1 w-24  mx-3 rounded-lg">
                <Text
                    className={
                        active === 2
                            ? 'bg-yellow-500 rounded-lg text-white px-3 py-2 text-base text-center font-semibold'
